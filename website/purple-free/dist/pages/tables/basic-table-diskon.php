...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title"> Data Diskon </h3>
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <a href="../../backend/promo/formtambah.php" class="btn btn-sm btn-primary mb-3">+ Tambah Diskon</a>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                $query = mysqli_query($conn, "SELECT * FROM kode_promo");
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if ($row['aktif'] == 1) {
                        ...
                        echo '<label class="badge badge-secondary">Nonaktif</label>';
                      }
                      ?>
                    </td>
                    ...
                    <td>
                      <a href="../../backend/promo/formedit.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                      <a href="../../backend/promo/delete.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin hapus diskon ini?')">Hapus</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
