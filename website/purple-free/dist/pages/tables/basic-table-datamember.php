  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="/website/purple-free/dist/backend/member/formtambah.php" class="btn btn-gradient-primary btn-sm">
          + Tambah Member
        </a>
      </div>

      <form method="GET" class="form-inline mb-3">
        <input type="text" name="keyword" class="form-control mr-2" placeholder="Cari member..." value="<?= htmlspecialchars($keyword) ?>">
        <button type="submit" class="btn btn-primary">Cari</button>
        <a href="basic-table-datamember.php" class="btn btn-secondary">Reset</a>
      </form>
