...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title">Data Review</h3>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <?php if ($row['foto']) { ?>
                        <img src="/website/assets/img/upload/review/<?= $row['foto']; ?>" style="height: 60px; border-radius: 6px;">
                      <?php } else {
                        echo '-';
                      } ?>
                    </td>
                    ...
                    <td>
                      <a href="../../backend/review/formedit.php?id=<?= $row['id_review']; ?>" class="btn btn-warning btn-sm">Edit</a>
                      <a href="../../backend/review/delete.php?id=<?= $row['id_review']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin hapus review ini?')">Hapus</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
