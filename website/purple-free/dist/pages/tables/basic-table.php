        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Semua tabel data cafe </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Tables</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Semua tabel data cafe</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="card">
                  ...
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="/website/purple-free//dist/backend/makanan/formtambah.php" class="btn btn-gradient-primary btn-sm">
                      + Tambah Menu
                    </a>
                  </div>

                      <form method="GET" class="form-inline mb-3">
                          <input type="text" name="keyword" class="form-control mr-2" placeholder="Cari menu..." value="<?= htmlspecialchars($keyword) ?>">
                          <select name="kategori" class="form-control mr-2">
                              <option value="">Semua Kategori</option>
                              <option value="kopi" <?= $kategori == 'kopi' ? 'selected' : '' ?>>Kopi</option>
                              <option value="bakery" <?= $kategori == 'bakery' ? 'selected' : '' ?>>Bakery</option>
                          </select>
                          <button type="submit" class="btn btn-primary">Cari</button>
                          <a href="basic-table.php" class="btn btn-secondary">Reset</a>
                      </form>
                          ...
                          <tbody>
                              <?php while($row = mysqli_fetch_assoc($result)) { ?>
                                  <tr>
                                      <td><?= $row['id_menu']; ?></td>
                                      <td><?= $row['nama_menu']; ?></td>
                                      <td><label class="badge badge-info"><?= $row['kategori']; ?></label></td>
                                      <td>Rp <?= number_format($row['harga'], 0, ',', '.'); ?></td>
                                      <td><?= $row['stok']; ?></td>
                                      <td>
                                        <a href="/website/purple-free/dist/backend/makanan/formedit.php?id=<?= $row['id_menu'] ?>" class="btn btn-warning btn-sm">
                                          <i class="mdi mdi-pencil"></i> Edit
                                        </a>
                                        <a href="/website/purple-free/dist/backend/makanan/delete.php?id=<?= $row['id_menu'] ?>" onclick="return confirm('Yakin hapus menu ini?')" class="btn btn-danger btn-sm">
