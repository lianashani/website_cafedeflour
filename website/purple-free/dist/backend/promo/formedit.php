...
$foto_kasir = "/website/purple-free/dist/assets/images/faces/" . $nama_kasir . ".jpeg";

include '../../../../config/koneksi.php';

$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM kode_promo WHERE id = $id");
...
if (isset($_POST['update'])) {
  ...
  header("Location: ../../pages/tables/diskon.php");
  exit;
}
?>
...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title"> Edit Diskon </h3>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Edit diskon</a></li>
          <li class="breadcrumb-item active" aria-current="page">Form Edit Diskon</li>
        </ol>
      </nav>
    </div>
...
<div class="container mt-5">
  <div class="card">
    <div class="card-body">
      ...
      <form method="POST" action="../../backend/promo/update.php">
        <!-- Menyisipkan ID tersembunyi -->
        ...
        <div class="form-group">
          ...
          <select name="jenis" class="form-control" required>
            <option value="persen" <?= $data['jenis'] == 'persen' ? 'selected' : ''; ?>>Persen</option>
            <option value="nominal" <?= $data['jenis'] == 'nominal' ? 'selected' : ''; ?>>Nominal</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="aktif" class="form-control" required>
            ...
            <option value="0" <?= $data['aktif'] == 0 ? 'selected' : ''; ?>>Nonaktif</option>
          </select>
        </div>
        ...
        <a href="../../pages/tables/basic-table-diskon.php" class="btn btn-light">Batal</a>
      </form>
    </div>
  </div>
</div>
