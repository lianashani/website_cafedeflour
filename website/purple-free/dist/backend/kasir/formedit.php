...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = "UPDATE kasir SET nama_kasir='$nama', alamat='$alamat', password='$password', jenis_kelamin='$jenis_kelamin' WHERE id_kasir=$id";

    if (mysqli_query($conn, $update)) {
        header("Location: ../../pages/tables/basic-table-kasir.php");
        exit;
    } else {
        echo "Gagal mengupdate kasir: " . mysqli_error($conn);
    }
}
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Edit Kasir</h4>
        <form method="POST">
          ...
          <a href="../../pages/tables/basic-table-kasir.php" class="btn btn-light">Batal</a>
        </form>
      </div>
    </div>
  </div>
