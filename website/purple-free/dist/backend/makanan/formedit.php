        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="card">
                ...
                <form class="forms-sample"  action="update.php?id=<?= $data['id_menu'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <select class="form-select" id="kategori" name="kategori" required>
                        ...
                        <option value="bakery" <?= $data['kategori'] == 'bakery' ? 'selected' : '' ?>>Bakery</option>
                    </select>
                    </div>
                    <div class="form-group">
                    ...
                    <?php if (!empty($data['gambar'])): ?>
                        <img src="../assets/img/<?= $data['gambar'] ?>" width="120"><br>
                    <?php else: ?>
                        <em>Belum ada gambar</em><br>
                    <?php endif; ?>
